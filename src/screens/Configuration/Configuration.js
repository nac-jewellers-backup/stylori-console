...
export const Configuration = withRouter(props => {
  const master_options = ['Attribute Master','Categories','ProductTypes', 'Materials','Metal Colours','Metal Purities','Master Collections','Master Designs','Master Weights','Master Diamond Types',
...
'Master Gender','SEO Priorities','Tax Settings 1','Tax Settings 2']
  const master_options_url = ['taxsettings','categories','producttypes', 'materialmaster','mastercolors','masterpurities','collections','designs','weights','diamonds','diamondsettings','diamondshapes','earringbacking',
